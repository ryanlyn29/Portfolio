...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md border border-zinc-400 dark:border-white/10 rounded-2xl px-6 py-3 flex items-center gap-8 pointer-events-auto shadow-xl">
        ...
        <button className="md:hidden text-zinc-900 dark:text-white font-mono uppercase text-xs font-bold">
          [MENU]
        </button>
      </div>
    </motion.nav>
